<?php
    ...
    $pdf->MultiCell($Column04, 6, "Όνομα",   1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Χρώμα",   1, 'C', 1, 1, 0, 0, true, 0);
    ...
    foreach( $data->rows as $row)
    {
        ...
        $pdf->MultiCell($Column00, 6, $row->boat_color_id, 1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column04, 6, $row->name,     1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->code,     1, 'L', 0, 1, 0, 0, true, 0);
    }
