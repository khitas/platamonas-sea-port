<?php
    ...
    $pdf->MultiCell($Column01, 6, "Όνομα",      1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Είδος",        1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Αρ. Εγγραφής", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Ημ. Εγγραφής", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Α.Μ.Υ.Ε.Ν. ", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Τύπος", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Κατάσταση", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Α.Ε.Π.",   1, 'C', 1, 1, 0, 0, true, 0);
    ...
    foreach( $data->rows as $row)
    {
        ...
        $pdf->MultiCell($Column00, 6, $row->boat_id,    1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->name,   1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->boat_kind,  1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->registry_type_number,  1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->registry_date_gr,   1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->amyen_type_number, 1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->boat_type, 1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->boat_status, 1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->license_expired_date_gr, 1, 'L', 0, 1, 0, 0, true, 0);
    }
