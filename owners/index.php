<?php
    ...
    $columns = array(
         "2" => array("name"=>"owner_id", "title"=>"Κωδικός", "cursor", "visible"),
         "3" => array("name"=>"lastname", "title"=>"Επώνυμο", "cursor", "visible"),
         "4" => array("name"=>"firstname", "title"=>"Όνομα", "cursor", "visible"),
         "5" => array("name"=>"fathername", "title"=>"Πατρώνυμο", "cursor"),
         "6" => array("name"=>"adt", "title"=>"Α.Δ.Τ.", "cursor"),
         "7" => array("name"=>"afm", "title"=>"Α.Φ.Μ.", "cursor"),
         "8" => array("name"=>"address", "title"=>"Διεύθυνση", "cursor", "visible"),
         "9" => array("name"=>"phone", "title"=>"Τηλέφωνο", "cursor"),
        "10" => array("name"=>"mobile", "title"=>"Κινητό", "cursor"),
        "11" => array("name"=>"count_boats", "title"=>"Σκάφη", "cursor", "visible" ),
        "12" => array("name"=>"count_engines", "title"=>"Μηχανές", "cursor", "visible" ),
    ...
    $orderBy = $_SESSION["states"][$package]["orderBy"] ? : "lastname";
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if (data.status == 200)
                {
                    ...
                    $("#txtLastName").val('<?php echo $advSearch["txtLastName"] ?>');
                    $("#txtFirstName").val('<?php echo $advSearch["txtFirstName"] ?>');
                    $("#txtFatherName").val('<?php echo $advSearch["txtFatherName"] ?>');
                    $("#txtADT").val('<?php echo $advSearch["txtADT"] ?>');
                    $("#txtAFM").val('<?php echo $advSearch["txtAFM"] ?>');
                    $("#txtAddress").val('<?php echo $advSearch["txtAddress"] ?>');
                    $("#txtPhone").val('<?php echo $advSearch["txtPhone"] ?>');
                    $("#txtMobile").val('<?php echo $advSearch["txtMobile"] ?>');
            ...
            success: function(response){
                ...
                if (data.status == 200)
                {
                    if (data.rows.length > 0)
                    {
                        $.each(data.rows, function(id, row)
                        {
                            var btnPrintInfos = '<td style="width: 80px"><button type="button" value="' + row.owner_id + '" class="btn btn-default btn-lg btn-block glyphicon glyphicon-print"></button></td>';
                            var $btnPrintInfos = $(btnPrintInfos).click(function() {
                                bootbox.prompt({
                                    ...
                                    callback : function(option) {
                                        ...
                                        {
                                            case "PrintInfos" :
                                                var data = {id:row.owner_id, print:option};
                            ...
                            var $btnEdit = $(btnEdit).click(function() {
                                window.location.href = "update/?id=" + row.owner_id;
                            });

                            <?php if (in_array($User["permission_id"], array(1, 2))) { ?>
                            var btnDelete = '<td style="width: 80px"><button type="button" value="' + row.owner_id + '" class="btn btn-default btn-lg btn-block glyphicon glyphicon-trash"></button></td>';
                            var $btnDelete = $(btnDelete).click(function() {
                                bootbox.dialog({
                                    message: 'Διαγραφή του Ιδιοκτήτη "'+row.owner_id+' : '+row.fullname+'";',
                                    title: "Διαγραφή",
                                    buttons: {
                                        success: {
                                            label: "Διαγραφή",
                    ...
                    {
                        var $rowdata = $('<tr></tr>');
                        $rowdata.append('<td colspan="15" align="center">'+data.message+'</td>');
                        $('#maintable > tbody').append($rowdata);
                    }
                            ...
                            <form class="form-horizontal col-sm-12" id="frm" role="form">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtLastName" id="txtLastName" placeholder="Επώνυμο">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtFirstName" id="txtFirstName" placeholder="Όνομα">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtFatherName" id="txtFatherName" placeholder="Πατρώνυμο">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtADT" id="txtADT" placeholder="Α.Δ.Τ.">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtAFM" id="txtAFM" placeholder="Α.Φ.Μ.">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtAddress" id="txtAddress" placeholder="Διεύθυνση">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtPhone" id="txtPhone" placeholder="Τηλέφωνο">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="txtMobile" id="txtMobile" placeholder="Κινητό">
                                        </div>
                                        <div class="col-sm-4">
