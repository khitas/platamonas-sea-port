<?php
    ...
    $pdf->MultiCell($Column150, 6, $row->owner_id,      0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Επώνυμο : ",        0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->lastname,      0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Όνομα : ",          0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->firstname,     0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Πατρώνυμο : ",      0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->fathername,    0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Α.Δ.Τ. : ",         0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->adt,           0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Α.Φ.Μ. : ",         0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->afm,           0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Διεύθυνση : ",      0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->address,       0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Τηλέφωνο : ",       0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->phone,         0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Κινητό : ",         0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->mobile,        0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Σκάφη : ",          0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->count_boats,   0, 'L', 0, 1, 0, 0, true, 0);

    $pdf->MultiCell($Column030, 6, "Μηχανές : ",        0, 'R', 0, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column150, 6, $row->count_engines, 0, 'L', 0, 1, 0, 0, true, 0);
