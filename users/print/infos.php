...
$pdf->MultiCell($Column01, 6, "Κωδικός : ",      0, 'R', 0, 0, 0, 0, true, 0);
$pdf->MultiCell($Column05, 6, $row->user_id,     0, 'L', 0, 1, 0, 0, true, 0);

$pdf->MultiCell($Column01, 6, "Επώνυμο : ",      0, 'R', 0, 0, 0, 0, true, 0);
$pdf->MultiCell($Column05, 6, $row->lastname,    0, 'L', 0, 1, 0, 0, true, 0);

$pdf->MultiCell($Column01, 6, "Όνομα : ",        0, 'R', 0, 0, 0, 0, true, 0);
$pdf->MultiCell($Column05, 6, $row->firstname,   0, 'L', 0, 1, 0, 0, true, 0);

$pdf->MultiCell($Column01, 6, "Όνομα Χρήστη : ", 0, 'R', 0, 0, 0, 0, true, 0);
$pdf->MultiCell($Column05, 6, $row->username,    0, 'L', 0, 1, 0, 0, true, 0);

$pdf->MultiCell($Column01, 6, "Δικαιώματα : ",   0, 'R', 0, 0, 0, 0, true, 0);
$pdf->MultiCell($Column05, 6, $row->permission,  0, 'L', 0, 1, 0, 0, true, 0);
