<?php
    ...
    $pdf->MultiCell($Column02, 6, "Επώνυμο",      1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Όνομα",        1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Όνομα Χρήστη", 1, 'C', 1, 0, 0, 0, true, 0);
    $pdf->MultiCell($Column01, 6, "Δικαιώματα",   1, 'C', 1, 1, 0, 0, true, 0);
    ...
    foreach( $data->rows as $row)
    {
        ...
        $pdf->MultiCell($Column00, 6, $row->user_id,    1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column02, 6, $row->lastname,   1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->firstname,  1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->username,   1, 'L', 0, 0, 0, 0, true, 0);
        $pdf->MultiCell($Column01, 6, $row->permission, 1, 'L', 0, 1, 0, 0, true, 0);
    }
